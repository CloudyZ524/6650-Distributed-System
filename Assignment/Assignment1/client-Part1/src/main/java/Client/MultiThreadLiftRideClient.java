...
public class MultiThreadLiftRideClient {
  ...
  private static int INITIAL_THREADS = 1;
  private static int REQUESTS_PER_THREAD = 1;
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    for (int i = 0; i < TOTAL_REQUESTS / REQUESTS_PER_THREAD; i++) {
      executor.execute(new PostingThread(GeneratorQueue, REQUESTS_PER_THREAD, successfulRequests, failedRequests, completed));
    }
